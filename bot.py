...
class Worker(QObject):
    ...
    sig_done = pyqtSignal(int)  # worker id: emitted at end of
    ...
    def work(self):
            ...
            if token1high<token1low or token2high<token2low or token3high<token3low or token4high<token4low or token5high<token5low or token6high<token6low or token7high<token7low or token8high<token8low or token9high<token9low or token10high<token10low or stoplosstoken1 > token1high or stoplosstoken2 > token2high or stoplosstoken3 > token3high or stoplosstoken4 > token4high or stoplosstoken5 > token5high or stoplosstoken6 > token6high or stoplosstoken7 > token7high or stoplosstoken8 > token8high or stoplosstoken9 > token9high or stoplosstoken10 > token10high:
                print('Stopping the script, a tokenlow is higher than its tokenhigh or a stoploss it higher than the tokenhigh')
                time.sleep(42949)
            ...
            def letstrade(keer2,tradewithERCtoken1, tradewithERCtoken2, tradewithERCtoken3, tradewithERCtoken4,
                          ...
                          token8high,
                          token8low, token9high, token9low, token10high, token10low, incaseofbuyinghowmuch, timesleepaftertrade,
                          ethtokeep,maincoinoption,fasttoken1,fasttoken2,fasttoken3,fasttoken4,fasttoken5,fasttoken6,fasttoken7,fasttoken8,fasttoken9,fasttoken10,stoplosstoken1,stoplosstoken2,stoplosstoken3,stoplosstoken4,stoplosstoken5,stoplosstoken6,stoplosstoken7,stoplosstoken8,stoplosstoken9,stoplosstoken10,stoplosschecktoken1,stoplosschecktoken2,stoplosschecktoken3,stoplosschecktoken4,stoplosschecktoken5,stoplosschecktoken6,stoplosschecktoken7,stoplosschecktoken8,stoplosschecktoken9,stoplosschecktoken10):

                def makeTrade(buytokenaddress, selltokenaddress, my_address, pk, max_slippage, infura_url,buysmallcasesymbol,sellsmallcasesymbol, ethtokeep):
                    def api2(ethaddress):
                        res = requests.get(
                    ...
                    if buytokenaddress == '0x0000000000000000000000000000000000000000':
                        gelukt='sell'
                    if buytokenaddress != '0x0000000000000000000000000000000000000000':
                ...
                try: #self added
                    ...
                    o=0
                try: #stop loss
                    if (pricetoken1usd < stoplosstoken1 and stoplosschecktoken1 == 1 and activatetoken1 == 1 and tradewithETHtoken1 == 1 and gelukt == "buy " + token1smallcasename) or (pricetoken1usd < stoplosstoken1 and activatetoken1 == 1 and tradewithETHtoken1 == 1 and gelukt2 == "buy " + token1smallcasename and stoplosschecktoken1 == 1):
                        print("Selling " + str(
                        ...
                        keer = 9999
                        fasttoken1 = 0
                    if (pricetoken2usd < stoplosstoken2 and activatetoken2 == 1 and stoplosschecktoken2 == 1 and tradewithETHtoken2 == 1 and gelukt == "buy " + token2smallcasename) or (pricetoken2usd < stoplosstoken2 and activatetoken2 == 1 and tradewithETHtoken2 == 1 and gelukt2 == "buy " + token2smallcasename and stoplosschecktoken2 == 1):
                        print("Selling " + str(
                        ...
                        keer = 9999
                        fasttoken2 = 0
                    if (pricetoken3usd < stoplosstoken3 and activatetoken3 == 1 and stoplosschecktoken3 == 1 and tradewithETHtoken3 == 1 and gelukt == "buy " + token3smallcasename) or (pricetoken3usd < stoplosstoken3 and activatetoken3 == 1 and tradewithETHtoken3 == 1 and gelukt2 == "buy " + token3smallcasename and stoplosschecktoken3 == 1):
                        print("Selling " + str(
                        ...
                        keer = 9999
                        fasttoken3 = 0
                    if (pricetoken4usd < stoplosstoken4 and activatetoken4 == 1 and stoplosschecktoken4 == 1 and tradewithETHtoken4 == 1 and gelukt == "buy " + token4smallcasename) or (pricetoken4usd < stoplosstoken4 and activatetoken4 == 1 and tradewithETHtoken4 == 1 and gelukt2 == "buy " + token4smallcasename and stoplosschecktoken4 == 1):
                        print("Selling " + str(
                        ...
                        keer = 9999
                        fasttoken4 = 0
                    if (pricetoken5usd < stoplosstoken5 and activatetoken5 == 1 and stoplosschecktoken5 == 1 and tradewithETHtoken5 == 1 and gelukt == "buy " + token5smallcasename) or (pricetoken5usd < stoplosstoken5 and activatetoken5 == 1 and tradewithETHtoken5 == 1 and gelukt2 == "buy " + token5smallcasename and stoplosschecktoken5 == 1):
                        print("Selling " + str(
                        ...
                        keer = 9999
                        fasttoken5 = 0
                    if (pricetoken6usd < stoplosstoken6 and activatetoken6 == 1 and stoplosschecktoken6 == 1 and tradewithETHtoken6 == 1 and gelukt == "buy " + token6smallcasename) or (pricetoken6usd < stoplosstoken6 and activatetoken6 == 1 and tradewithETHtoken6 == 1 and gelukt2 == "buy " + token6smallcasename and stoplosschecktoken6 == 1):
                        print("Selling " + str(
                        ...
                        keer = 9999
                        fasttoken6 = 0
                    if (pricetoken7usd < stoplosstoken7 and activatetoken7 == 1 and stoplosschecktoken7 == 1 and tradewithETHtoken7 == 1 and gelukt == "buy " + token7smallcasename) or (pricetoken7usd < stoplosstoken7 and activatetoken7 == 1 and tradewithETHtoken7 == 1 and gelukt2 == "buy " + token7smallcasename and stoplosschecktoken7 == 1):
                        print("Selling " + str(
                        ...
                        keer = 9999
                        fasttoken7 = 0
                    if (pricetoken8usd < stoplosstoken8 and activatetoken8 == 1 and stoplosschecktoken8 == 1 and tradewithETHtoken8 == 1 and gelukt == "buy " + token8smallcasename) or (pricetoken8usd < stoplosstoken8 and activatetoken8 == 1 and tradewithETHtoken8 == 1 and gelukt2 == "buy " + token8smallcasename and stoplosschecktoken8 == 1):
                        print("Selling " + str(
                        ...
                        keer = 9999
                        fasttoken8 = 0
                    if (pricetoken9usd < stoplosstoken9 and activatetoken9 == 1 and stoplosschecktoken9 == 1 and tradewithETHtoken9 == 1 and gelukt == "buy " + token9smallcasename) or (pricetoken9usd < stoplosstoken9 and activatetoken9 == 1 and tradewithETHtoken9 == 1 and gelukt2 == "buy " + token9smallcasename and stoplosschecktoken9 == 1):
                        print("Selling " + str(
                        ...
                        keer = 9999
                        fasttoken9 = 0
                    if (pricetoken10usd < stoplosstoken10 and activatetoken10 == 1 and stoplosschecktoken10 == 1 and tradewithETHtoken10 == 1 and gelukt == "buy " + token10smallcasename) or (pricetoken10usd < stoplosstoken10 and activatetoken10 == 1 and tradewithETHtoken10 == 1 and gelukt2 == "buy " + token10smallcasename and stoplosschecktoken10 == 1):
                        print("Selling " + str(
                ...
                try:  # sell alt and buy ETH trades
                    if (token1address != 0 ) and activatetoken1 == 1 and tradewithETHtoken1 == 1:
                        if (pricetoken1usd > token1high and gelukt == "buy " + token1smallcasename) or (
                                pricetoken1usd > token1high and gelukt2 == "buy " + token1smallcasename) or (activatetoken1==1 and gelukt=='buy '+token1smallcasename and fasttoken1==1):
                            print("Selling "+str(token1smallcasename)+' for Maincoin-option (current price in USD: ' + str(pricetoken1usd) + ')')
                            if maincoinoption != '0x0000000000000000000000000000000000000000':
                                buysmallcasesymbol= str(cg.get_coin_info_from_contract_address_by_id(contract_address=ethaddress, id='ethereum')['symbol'])
                            else:
                                buysmallcasesymbol= 'eth'
                            kaka = makeTrade(buytokenaddress=ethaddress, selltokenaddress=token1address,
                                             my_address=my_address,
                    ...
                    if (token2address != 0 ) and activatetoken2 == 1 and tradewithETHtoken2 == 1:
                        if (pricetoken2usd >= token2high and gelukt == "buy " + token2smallcasename) or (
                                pricetoken2usd > token2high and gelukt2 == "buy " + token2smallcasename) or (fasttoken2==1):
                            print("Selling "+str(token2smallcasename)+' for Maincoin-option (current price in USD: ' + str(pricetoken2usd) + ')')
                            if maincoinoption != '0x0000000000000000000000000000000000000000':
                                buysmallcasesymbol= str(cg.get_coin_info_from_contract_address_by_id(contract_address=ethaddress, id='ethereum')['symbol'])
                            else:
                                buysmallcasesymbol= 'eth'
                    ...
                    if (token3address != 0 ) and activatetoken3 == 1 and tradewithETHtoken3 == 1:
                        if (pricetoken3usd > token3high and gelukt == "buy " + token3smallcasename) or (
                                pricetoken3usd > token3high and gelukt2 == "buy " + token3smallcasename) or (fasttoken3==1):
                            print("Selling "+str(token3smallcasename)+' for Maincoin-option (current price in USD: ' + str(pricetoken3usd) + ')')
                            if maincoinoption != '0x0000000000000000000000000000000000000000':
                                buysmallcasesymbol= str(cg.get_coin_info_from_contract_address_by_id(contract_address=ethaddress, id='ethereum')['symbol'])
                            else:
                                buysmallcasesymbol= 'eth'
                    ...
                    if (token4address != 0 ) and activatetoken4 == 1 and tradewithETHtoken4 == 1:
                        if (pricetoken4usd > token4high and gelukt == "buy " + token4smallcasename) or (
                                pricetoken4usd > token4high and gelukt2 == "buy " + token4smallcasename) or (fasttoken4==1):
                            print("Selling "+str(token4smallcasename)+' for Maincoin-option (current price in USD: ' + str(pricetoken4usd) + ')')
                            if maincoinoption != '0x0000000000000000000000000000000000000000':
                                buysmallcasesymbol= str(cg.get_coin_info_from_contract_address_by_id(contract_address=ethaddress, id='ethereum')['symbol'])
                            else:
                                buysmallcasesymbol= 'eth'
                    ...
                    if (token5address != 0 ) and activatetoken5 == 1 and tradewithETHtoken5 == 1:
                        if (pricetoken5usd > token5high and gelukt == "buy " + token5smallcasename) or (
                                pricetoken5usd > token5high and gelukt2 == "buy " + token5smallcasename) or (fasttoken5==1):
                            print("Selling "+str(token5smallcasename)+' for Maincoin-option (current price in USD: ' + str(pricetoken5usd) + ')')
                            if maincoinoption != '0x0000000000000000000000000000000000000000':
                                buysmallcasesymbol= str(cg.get_coin_info_from_contract_address_by_id(contract_address=ethaddress, id='ethereum')['symbol'])
                            else:
                                buysmallcasesymbol= 'eth'
                    ...
                    if (token6address != 0 ) and activatetoken6 == 1 and tradewithETHtoken6 == 1:
                        if (pricetoken6usd > token6high and gelukt == "buy " + token6smallcasename) or (
                                pricetoken6usd > token6high and gelukt2 == "buy " + token6smallcasename) or (fasttoken6==1):
                            print("Selling "+str(token6smallcasename)+' for Maincoin-option (current price in USD: ' + str(pricetoken6usd) + ')')
                            if maincoinoption != '0x0000000000000000000000000000000000000000':
                                buysmallcasesymbol= str(cg.get_coin_info_from_contract_address_by_id(contract_address=ethaddress, id='ethereum')['symbol'])
                            else:
                                buysmallcasesymbol= 'eth'
                    ...
                    if (token7address != 0 ) and activatetoken7 == 1 and tradewithETHtoken7 == 1:
                        if (pricetoken7usd > token7high and gelukt == "buy " + token7smallcasename) or (
                                pricetoken7usd > token7high and gelukt2 == "buy " + token7smallcasename) or (fasttoken7==1):
                            print("Selling "+str(token7smallcasename)+' for Maincoin-option (current price in USD: ' + str(pricetoken7usd) + ')')
                            if maincoinoption != '0x0000000000000000000000000000000000000000':
                                buysmallcasesymbol= str(cg.get_coin_info_from_contract_address_by_id(contract_address=ethaddress, id='ethereum')['symbol'])
                            else:
                                buysmallcasesymbol= 'eth'
                    ...
                    if (token8address != 0 ) and activatetoken8 == 1 and tradewithETHtoken8 == 1:
                        if (pricetoken8usd > token8high and gelukt == "buy " + token8smallcasename) or (
                                pricetoken8usd > token8high and gelukt2 == "buy " + token8smallcasename) or (fasttoken8==1):
                            print("Selling "+str(token8smallcasename)+' for Maincoin-option (current price in USD: ' + str(pricetoken8usd) + ')')
                            if maincoinoption != '0x0000000000000000000000000000000000000000':
                                buysmallcasesymbol= str(cg.get_coin_info_from_contract_address_by_id(contract_address=ethaddress, id='ethereum')['symbol'])
                            else:
                                buysmallcasesymbol= 'eth'
                    ...
                    if (token9address != 0 ) and activatetoken9 == 1 and tradewithETHtoken9 == 1:
                        if (pricetoken9usd > token9high and gelukt == "buy " + token9smallcasename) or (
                                pricetoken9usd > token9high and gelukt2 == "buy " + token9smallcasename) or (fasttoken9==1):
                            print("Selling "+str(token9smallcasename)+' for Maincoin-option (current price in USD: ' + str(pricetoken9usd) + ')')
                            if maincoinoption != '0x0000000000000000000000000000000000000000':
                                buysmallcasesymbol= str(cg.get_coin_info_from_contract_address_by_id(contract_address=ethaddress, id='ethereum')['symbol'])
                            else:
                                buysmallcasesymbol= 'eth'
                    ...
                    if (token10address != 0 ) and activatetoken10 == 1 and tradewithETHtoken10 == 1:
                        if (pricetoken10usd > token10high and gelukt == "buy " + token10smallcasename) or (
                                pricetoken10usd > token10high and gelukt2 == "buy " + token10smallcasename) or (fasttoken10==1):
                            print("Selling "+str(token10smallcasename)+' for Maincoin-option (current price in USD: ' + str(pricetoken10usd) + ')')
                            if maincoinoption != '0x0000000000000000000000000000000000000000':
                                buysmallcasesymbol= str(cg.get_coin_info_from_contract_address_by_id(contract_address=ethaddress, id='ethereum')['symbol'])
                            else:
                                buysmallcasesymbol= 'eth'
                ...
                try:  # sell ETH and buy ALT
                    if (token1address != 0 ) and activatetoken1 == 1 and tradewithETHtoken1 == 1:
                        if (pricetoken1usd < token1low and gelukt == "sell") or (
                            ...
                            print("Buying "+str(token1smallcasename)+' (Current price: '+str(int(pricetoken1usd)) + ')')
                            if maincoinoption != '0x0000000000000000000000000000000000000000':
                                sellsmallcasesymbol= str(cg.get_coin_info_from_contract_address_by_id(contract_address=ethaddress, id='ethereum')['symbol'])
                            else:
                    ...
                    if (token2address != 0 ) and activatetoken2 == 1 and tradewithETHtoken2 == 1:
                        if (pricetoken2usd < token2low and gelukt == "sell") or (
                            ...
                            print("Buying "+str(int(token2smallcasename))+' (Current price: '+str(int(pricetoken2usd)) + ')')
                            if maincoinoption != '0x0000000000000000000000000000000000000000':
                                sellsmallcasesymbol= str(cg.get_coin_info_from_contract_address_by_id(contract_address=ethaddress, id='ethereum')['symbol'])
                            else:
                                sellsmallcasesymbol = 'eth'
                        ...
                        try:  # token1 to others
                            if (token1address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token1smallcasename)+ ' ($'+str(pricetoken1usd)+') for '+str(token2smallcasename)+" ($"+str(pricetoken2usd)+")")
                            ...
                            if (token1address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token1smallcasename)+ ' ($'+str(pricetoken1usd)+') for '+str(token3smallcasename)+" ($"+str(pricetoken3usd)+")")
                            ...
                            if (token1address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token1smallcasename)+ ' ($'+str(pricetoken1usd)+') for '+str(token4smallcasename)+" ($"+str(pricetoken4usd)+")")
                            ...
                            if (token1address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token1smallcasename)+ ' ($'+str(pricetoken1usd)+') for '+str(token5smallcasename)+" ($"+str(pricetoken5usd)+")")
                            ...
                            if (token1address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token1smallcasename)+ ' ($'+str(pricetoken1usd)+') for '+str(token6smallcasename)+" ($"+str(pricetoken6usd)+")")
                            ...
                            if (token1address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token1smallcasename)+ ' ($'+str(pricetoken1usd)+') for '+str(token7smallcasename)+" ($"+str(pricetoken7usd)+")")
                            ...
                            if (token1address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token1smallcasename)+ ' ($'+str(pricetoken1usd)+') for '+str(token8smallcasename)+" ($"+str(pricetoken8usd)+")")
                            ...
                            if (token1address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token1smallcasename)+ ' ($'+str(pricetoken1usd)+') for '+str(token9smallcasename)+" ($"+str(pricetoken9usd)+")")
                            ...
                            if (token1address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token1smallcasename)+ ' ($'+str(pricetoken1usd)+') for '+str(token10smallcasename)+" ($"+str(pricetoken10usd)+")")
                        ...
                        try:  # token2 to others
                            if (token2address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token2smallcasename)+ ' ($'+str(pricetoken2usd)+') for '+str(token1smallcasename)+" ($"+str(pricetoken1usd)+")")
                            ...
                            if (token2address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token2smallcasename)+ ' ($'+str(pricetoken2usd)+') for '+str(token3smallcasename)+" ($"+str(pricetoken3usd)+")")
                            ...
                            if (token2address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token2smallcasename)+ ' ($'+str(pricetoken2usd)+') for '+str(token4smallcasename)+" ($"+str(pricetoken4usd)+")")
                            ...
                            if (token2address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token2smallcasename)+ ' ($'+str(pricetoken2usd)+') for '+str(token5smallcasename)+" ($"+str(pricetoken5usd)+")")
                            ...
                            if (token2address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token2smallcasename)+ ' ($'+str(pricetoken2usd)+') for '+str(token6smallcasename)+" ($"+str(pricetoken6usd)+")")
                            ...
                            if (token2address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token2smallcasename)+ ' ($'+str(pricetoken2usd)+') for '+str(token7smallcasename)+" ($"+str(pricetoken7usd)+")")
                            ...
                            if (token2address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token2smallcasename)+ ' ($'+str(pricetoken2usd)+') for '+str(token8smallcasename)+" ($"+str(pricetoken8usd)+")")
                            ...
                            if (token2address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token2smallcasename)+ ' ($'+str(pricetoken2usd)+') for '+str(token9smallcasename)+" ($"+str(pricetoken9usd)+")")
                            ...
                            if (token2address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token2smallcasename)+ ' ($'+str(pricetoken2usd)+') for '+str(token10smallcasename)+" ($"+str(pricetoken10usd)+")")
                        ...
                        try:  # token3 to others
                            if (token3address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token3smallcasename)+ ' ($'+str(pricetoken3usd)+') for '+str(token1smallcasename)+" ($"+str(pricetoken1usd)+")")
                            ...
                            if (token3address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token3smallcasename)+ ' ($'+str(pricetoken3usd)+') for '+str(token2smallcasename)+" ($"+str(pricetoken2usd)+")")
                            ...
                            if (token3address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token3smallcasename)+ ' ($'+str(pricetoken3usd)+') for '+str(token4smallcasename)+" ($"+str(pricetoken4usd)+")")
                            ...
                            if (token3address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token3smallcasename)+ ' ($'+str(pricetoken3usd)+') for '+str(token5smallcasename)+" ($"+str(pricetoken5usd)+")")
                            ...
                            if (token3address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token3smallcasename)+ ' ($'+str(pricetoken3usd)+') for '+str(token6smallcasename)+" ($"+str(pricetoken6usd)+")")
                            ...
                            if (token3address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token3smallcasename)+ ' ($'+str(pricetoken3usd)+') for '+str(token7smallcasename)+" ($"+str(pricetoken7usd)+")")
                            ...
                            if (token3address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token3smallcasename)+ ' ($'+str(pricetoken3usd)+') for '+str(token8smallcasename)+" ($"+str(pricetoken8usd)+")")
                            ...
                            if (token3address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token3smallcasename)+ ' ($'+str(pricetoken3usd)+') for '+str(token9smallcasename)+" ($"+str(pricetoken9usd)+")")
                            ...
                            if (token3address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token3smallcasename)+ ' ($'+str(pricetoken3usd)+') for '+str(token10smallcasename)+" ($"+str(pricetoken10usd)+")")
                        ...
                        try:  # token4 to others
                            if (token4address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token4smallcasename)+ ' ($'+str(pricetoken4usd)+') for '+str(token2smallcasename)+" ($"+str(pricetoken2usd)+")")
                            ...
                            if (token4address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token4smallcasename)+ ' ($'+str(pricetoken4usd)+') for '+str(token1smallcasename)+" ($"+str(pricetoken1usd)+")")
                            ...
                            if (token4address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token4smallcasename)+ ' ($'+str(pricetoken4usd)+') for '+str(token3smallcasename)+" ($"+str(pricetoken3usd)+")")
                            ...
                            if (token4address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token4smallcasename)+ ' ($'+str(pricetoken4usd)+') for '+str(token5smallcasename)+" ($"+str(pricetoken5usd)+")")
                            ...
                            if (token4address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token4smallcasename)+ ' ($'+str(pricetoken4usd)+') for '+str(token6smallcasename)+" ($"+str(pricetoken6usd)+")")
                            ...
                            if (token4address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token4smallcasename)+ ' ($'+str(pricetoken4usd)+') for '+str(token7smallcasename)+" ($"+str(pricetoken7usd)+")")
                            ...
                            if (token4address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token4smallcasename)+ ' ($'+str(pricetoken4usd)+') for '+str(token8smallcasename)+" ($"+str(pricetoken8usd)+")")
                            ...
                            if (token4address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token4smallcasename)+ ' ($'+str(pricetoken4usd)+') for '+str(token9smallcasename)+" ($"+str(pricetoken9usd)+")")
                            ...
                            if (token4address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token4smallcasename)+ ' ($'+str(pricetoken4usd)+') for '+str(token10smallcasename)+" ($"+str(pricetoken10usd)+")")
                        ...
                        try:  # token5 to others
                            if (token5address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token5smallcasename)+ ' ($'+str(pricetoken5usd)+') for '+str(token2smallcasename)+" ($"+str(pricetoken2usd)+")")
                            ...
                            if (token5address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token5smallcasename)+ ' ($'+str(pricetoken5usd)+') for '+str(token3smallcasename)+" ($"+str(pricetoken3usd)+")")
                            ...
                            if (token5address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token5smallcasename)+ ' ($'+str(pricetoken5usd)+') for '+str(token1smallcasename)+" ($"+str(pricetoken1usd)+")")
                            ...
                            if (token5address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token5smallcasename)+ ' ($'+str(pricetoken5usd)+') for '+str(token4smallcasename)+" ($"+str(pricetoken4usd)+")")
                            ...
                            if (token5address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token5smallcasename)+ ' ($'+str(pricetoken5usd)+') for '+str(token6smallcasename)+" ($"+str(pricetoken6usd)+")")
                            ...
                            if (token5address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token5smallcasename)+ ' ($'+str(pricetoken5usd)+') for '+str(token7smallcasename)+" ($"+str(pricetoken7usd)+")")
                            ...
                            if (token5address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token5smallcasename)+ ' ($'+str(pricetoken5usd)+') for '+str(token8smallcasename)+" ($"+str(pricetoken8usd)+")")
                            ...
                            if (token5address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token5smallcasename)+ ' ($'+str(pricetoken5usd)+') for '+str(token9smallcasename)+" ($"+str(pricetoken9usd)+")")
                            ...
                            if (token5address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token5smallcasename)+ ' ($'+str(pricetoken5usd)+') for '+str(token10smallcasename)+" ($"+str(pricetoken10usd)+")")
                        ...
                        try:  # token6 to others
                            if (token6address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token6smallcasename)+ ' ($'+str(pricetoken6usd)+') for '+str(token2smallcasename)+" ($"+str(pricetoken2usd)+")")
                            ...
                            if (token6address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token6smallcasename)+ ' ($'+str(pricetoken6usd)+') for '+str(token3smallcasename)+" ($"+str(pricetoken3usd)+")")
                            ...
                            if (token6address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token6smallcasename)+ ' ($'+str(pricetoken6usd)+') for '+str(token4smallcasename)+" ($"+str(pricetoken4usd)+")")
                            ...
                            if (token6address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token6smallcasename)+ ' ($'+str(pricetoken6usd)+') for '+str(token1smallcasename)+" ($"+str(pricetoken1usd)+")")
                            ...
                            if (token6address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token6smallcasename)+ ' ($'+str(pricetoken6usd)+') for '+str(token5smallcasename)+" ($"+str(pricetoken5usd)+")")
                            ...
                            if (token6address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token6smallcasename)+ ' ($'+str(pricetoken6usd)+') for '+str(token7smallcasename)+" ($"+str(pricetoken7usd)+")")
                            ...
                            if (token6address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token6smallcasename)+ ' ($'+str(pricetoken6usd)+') for '+str(token8smallcasename)+" ($"+str(pricetoken8usd)+")")
                            ...
                            if (token6address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token6smallcasename)+ ' ($'+str(pricetoken6usd)+') for '+str(token9smallcasename)+" ($"+str(pricetoken9usd)+")")
                            ...
                            if (token6address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token6smallcasename)+ ' ($'+str(pricetoken6usd)+') for '+str(token10smallcasename)+" ($"+str(pricetoken10usd)+")")
                        ...
                        try:  # token7 to others
                            if (token7address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token7smallcasename)+ ' ($'+str(pricetoken7usd)+') for '+str(token2smallcasename)+" ($"+str(pricetoken2usd)+")")
                            ...
                            if (token7address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token7smallcasename)+ ' ($'+str(pricetoken7usd)+') for '+str(token3smallcasename)+" ($"+str(pricetoken3usd)+")")
                            ...
                            if (token7address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token7smallcasename)+ ' ($'+str(pricetoken7usd)+') for '+str(token4smallcasename)+" ($"+str(pricetoken4usd)+")")
                            ...
                            if (token7address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token7smallcasename)+ ' ($'+str(pricetoken7usd)+') for '+str(token5smallcasename)+" ($"+str(pricetoken5usd)+")")
                            ...
                            if (token7address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token7smallcasename)+ ' ($'+str(pricetoken7usd)+') for '+str(token1smallcasename)+" ($"+str(pricetoken1usd)+")")
                            ...
                            if (token7address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token7smallcasename)+ ' ($'+str(pricetoken7usd)+') for '+str(token6smallcasename)+" ($"+str(pricetoken6usd)+")")
                            ...
                            if (token7address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token7smallcasename)+ ' ($'+str(pricetoken7usd)+') for '+str(token8smallcasename)+" ($"+str(pricetoken8usd)+")")
                            ...
                            if (token7address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token7smallcasename)+ ' ($'+str(pricetoken7usd)+') for '+str(token9smallcasename)+" ($"+str(pricetoken9usd)+")")
                            ...
                            if (token7address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token7smallcasename)+ ' ($'+str(pricetoken7usd)+') for '+str(token10smallcasename)+" ($"+str(pricetoken10usd)+")")
                        ...
                        try:  # token8 to others
                            if (token8address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token8smallcasename)+ ' ($'+str(pricetoken8usd)+') for '+str(token2smallcasename)+" ($"+str(pricetoken2usd)+")")
                            ...
                            if (token8address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token8smallcasename)+ ' ($'+str(pricetoken8usd)+') for '+str(token3smallcasename)+" ($"+str(pricetoken3usd)+")")
                            ...
                            if (token8address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token8smallcasename)+ ' ($'+str(pricetoken8usd)+') for '+str(token4smallcasename)+" ($"+str(pricetoken4usd)+")")
                            ...
                            if (token8address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token8smallcasename)+ ' ($'+str(pricetoken8usd)+') for '+str(token5smallcasename)+" ($"+str(pricetoken5usd)+")")
                            ...
                            if (token8address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token8smallcasename)+ ' ($'+str(pricetoken8usd)+') for '+str(token6smallcasename)+" ($"+str(pricetoken6usd)+")")
                            ...
                            if (token8address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token8smallcasename)+ ' ($'+str(pricetoken8usd)+') for '+str(token1smallcasename)+" ($"+str(pricetoken1usd)+")")
                            ...
                            if (token8address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token8smallcasename)+ ' ($'+str(pricetoken8usd)+') for '+str(token7smallcasename)+" ($"+str(pricetoken7usd)+")")
                            ...
                            if (token8address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token8smallcasename)+ ' ($'+str(pricetoken8usd)+') for '+str(token9smallcasename)+" ($"+str(pricetoken9usd)+")")
                            ...
                            if (token8address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token8smallcasename)+ ' ($'+str(pricetoken8usd)+') for '+str(token10smallcasename)+" ($"+str(pricetoken10usd)+")")
                        ...
                        try:  # token9 to others
                            if (token9address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token9smallcasename)+ ' ($'+str(pricetoken9usd)+') for '+str(token2smallcasename)+" ($"+str(pricetoken2usd)+")")
                            ...
                            if (token9address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token9smallcasename)+ ' ($'+str(pricetoken9usd)+') for '+str(token3smallcasename)+" ($"+str(pricetoken3usd)+")")
                            ...
                            if (token9address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token9smallcasename)+ ' ($'+str(pricetoken9usd)+') for '+str(token4smallcasename)+" ($"+str(pricetoken4usd)+")")
                            ...
                            if (token9address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token9smallcasename)+ ' ($'+str(pricetoken9usd)+') for '+str(token5smallcasename)+" ($"+str(pricetoken5usd)+")")
                            ...
                            if (token9address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token9smallcasename)+ ' ($'+str(pricetoken9usd)+') for '+str(token6smallcasename)+" ($"+str(pricetoken6usd)+")")
                            ...
                            if (token9address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token9smallcasename)+ ' ($'+str(pricetoken9usd)+') for '+str(token7smallcasename)+" ($"+str(pricetoken7usd)+")")
                            ...
                            if (token9address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token9smallcasename)+ ' ($'+str(pricetoken9usd)+') for '+str(token8smallcasename)+" ($"+str(pricetoken8usd)+")")
                            ...
                            if (token9address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token9smallcasename)+ ' ($'+str(pricetoken9usd)+') for '+str(token1smallcasename)+" ($"+str(pricetoken1usd)+")")
                            ...
                            if (token9address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token9smallcasename)+ ' ($'+str(pricetoken9usd)+') for '+str(token10smallcasename)+" ($"+str(pricetoken10usd)+")")
                        ...
                        try:  # token10 to others
                            if (token10address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token10smallcasename)+ ' ($'+str(pricetoken10usd)+') for '+str(token2smallcasename)+" ($"+str(pricetoken2usd)+")")
                            ...
                            if (token10address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token10smallcasename)+ ' ($'+str(pricetoken10usd)+') for '+str(token3smallcasename)+" ($"+str(pricetoken3usd)+")")
                            ...
                            if (token10address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token10smallcasename)+ ' ($'+str(pricetoken10usd)+') for '+str(token4smallcasename)+" ($"+str(pricetoken4usd)+")")
                            ...
                            if (token10address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token10smallcasename)+ ' ($'+str(pricetoken10usd)+') for '+str(token5smallcasename)+" ($"+str(pricetoken5usd)+")")
                            ...
                            if (token10address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token10smallcasename)+ ' ($'+str(pricetoken10usd)+') for '+str(token6smallcasename)+" ($"+str(pricetoken6usd)+")")
                            ...
                            if (token10address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token10smallcasename)+ ' ($'+str(pricetoken10usd)+') for '+str(token7smallcasename)+" ($"+str(pricetoken7usd)+")")
                            ...
                            if (token10address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token10smallcasename)+ ' ($'+str(pricetoken10usd)+') for '+str(token8smallcasename)+" ($"+str(pricetoken8usd)+")")
                            ...
                            if (token10address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token10smallcasename)+ ' ($'+str(pricetoken10usd)+') for '+str(token1smallcasename)+" ($"+str(pricetoken1usd)+")")
                            ...
                            if (token10address != 0 ) and (
                                ...
                                if (
                                    ...
                                    print("Trading "+ str(token10smallcasename)+ ' ($'+str(pricetoken10usd)+') for '+str(token9smallcasename)+" ($"+str(pricetoken9usd)+")")
                ...
                if 'keer' not in locals():
                    keer=keer2
                return {'gelukt': gelukt, 'keer':keer, 'fasttoken1':fasttoken1,'fasttoken2':fasttoken2,'fasttoken3':fasttoken3,'fasttoken4':fasttoken4,'fasttoken5':fasttoken5,'fasttoken6':fasttoken6,'fasttoken7':fasttoken7,'fasttoken8':fasttoken8,'fasttoken9':fasttoken9,'fasttoken10':fasttoken10}
            ...
            def checkbalance(infura_url, my_address, token1address, token2address, token3address, token4address,
                ...
                try:
                    if maincoinoption == "0x0000000000000000000000000000000000000000":
                        ...
                        ethamount2 = math.floor(
                            ethbalance.get_token_balance(token2, ethereum_address)['balance'])
                    if (maincoinoption == "0x0000000000000000000000000000000000000000" and ethamount2 > 0.1) or (
                            maincoinoption != "0x0000000000000000000000000000000000000000" and ethamount2 > 1):
                        gelukt = "sell"
                    if (ethamount2 < 0.1 and maincoinoption == "0x0000000000000000000000000000000000000000") or (
                            ethamount2 < 1 and maincoinoption != "0x0000000000000000000000000000000000000000"):
                        token = token1smallcasename.upper
                        selldecimals = int(api(token1address))
                        details = {'symbol': token, 'address': token1address, 'decimals': selldecimals,
                                   'name': token}
                        ...
                        if balance_token1 < 3 and str(token2address) != '0':
                            ...
                            selldecimals = int(api(token2address))
                            details = {'symbol': token, 'address': token2address, 'decimals': selldecimals,
                                       'name': token}
                            erc20tokens = ethbalance.add_token(token, details)
                            ...
                            if balance_token2 < 3 and str(token3address) != '0':
                                ...
                                selldecimals = int(api(token3address))
                                details = {'symbol': token, 'address': token3address, 'decimals': selldecimals,
                                           'name': token}
                                ...
                                if balance_token3 < 3 and str(token4address) != '0':
                                    ...
                                    selldecimals = int(api(token4address))
                                    details = {'symbol': token, 'address': token4address, 'decimals': selldecimals,
                                               'name': token}
                                    erc20tokens = ethbalance.add_token(token, details)
                                    ...
                                    if balance_token4 < 3 and str(token5address) != '0':
                                        ...
                                        selldecimals = int(api(token5address))
                                        details = {'symbol': token, 'address': token5address, 'decimals': selldecimals,
                                                   'name': token}
                                        erc20tokens = ethbalance.add_token(token, details)
                                        ...
                                        if balance_token5 < 3 and str(token6address) != '0':
                                            ...
                                            selldecimals = int(api(token6address))
                                            details = {'symbol': token, 'address': token6address, 'decimals': selldecimals,
                                                       'name': token}
                                            erc20tokens = ethbalance.add_token(token, details)
                                            ...
                                            if balance_token6 < 3 and str(token7address) != '0':
                                                ...
                                                selldecimals = int(api(token7address))
                                                details = {'symbol': token, 'address': token7address, 'decimals': selldecimals,
                                                           'name': token}
                                                erc20tokens = ethbalance.add_token(token, details)
                                                ...
                                                if balance_token7 < 3 and str(token8address) != '0':
                                                    ...
                                                    selldecimals = int(api(token8address))
                                                    ...
                                                    if balance_token8 < 3 and str(token9address) != '0':
                                                        ...
                                                        selldecimals = int(api(token9address))
                                                        ...
                                                        if balance_token9 < 3 and str(token10address) != '0':
                                                            ...
                                                            selldecimals = int(api(token10address))
                ...
                try:
                    if maincoinoption == "0x0000000000000000000000000000000000000000":
                        ...
                        ethamount2 = math.floor(
                            ethbalance.get_token_balance(token2, ethereum_address)['balance'])
                    if (
                            maincoinoption == "0x0000000000000000000000000000000000000000" and ethamount2 > 0.1 and gelukt != "sell") or (
                    ...
                    if (ethamount2 < 0.1 and maincoinoption == "0x0000000000000000000000000000000000000000" ) or (
                        ...
                        if balance_token1 < 3 and str(token2address) != '0' or (balance_token1 > 3 and gelukt == ("buy " + str(token1smallcasename)) and str(token2address) != '0'):
                            token = token2smallcasename.upper
                            selldecimals = int(api(token2address))
                            details = {'symbol': token, 'address': token2address, 'decimals': selldecimals,
                                       'name': token}
                            ...
                            if balance_token2 < 3 and str(token3address) != '0' or (balance_token2 > 3 and gelukt == ("buy " + str(token2smallcasename)) and str(token3address) != '0'):
                                token = (token3smallcasename).upper
                                selldecimals = int(api(token3address))
                                details = {'symbol': token, 'address': token3address, 'decimals': selldecimals,
                                           'name': token}
                                ...
                                if balance_token3 < 3 and str(token4address) != '0' or (balance_token3 > 3 and gelukt == ("buy " + str(token3smallcasename)) and str(token4address) != '0'):
                                    token = token4smallcasename.upper
                                    selldecimals = int(api(token4address))
                                    details = {'symbol': token, 'address': token4address, 'decimals': selldecimals,
                                               'name': token}
                                    ...
                                    if balance_token4 < 3 and str(token5address) != '0' or (balance_token4 > 3 and gelukt == ("buy " + str(token4smallcasename)) and str(token5address) != '0'):
                                        token = token5smallcasename.upper
                                        selldecimals = int(api(token5address))
                                        details = {'symbol': token, 'address': token5address, 'decimals': selldecimals,
                                                   'name': token}
                                        ...
                                        if balance_token5 < 3 and str(token6address) != '0' or (balance_token5 > 3 and gelukt == ("buy " + str(token5smallcasename)) and str(token6address) != '0'):
                                            token = token6smallcasename.upper
                                            selldecimals = int(api(token6address))
                                            details = {'symbol': token, 'address': token6address, 'decimals': selldecimals,
                                                       'name': token}
                                            ...
                                            if balance_token6 < 3 and str(token7address) != '0' or (balance_token6 > 3 and gelukt == ("buy " + str(token6smallcasename)) and str(token7address) != '0'):
                                                token = token7smallcasename.upper
                                                selldecimals = int(api(token7address))
                                                details = {'symbol': token, 'address': token7address, 'decimals': selldecimals,
                                                           'name': token}
                                                ...
                                                if balance_token7 < 3 and str(token8address) != '0' or (balance_token7 > 3 and gelukt == ("buy " + str(token7smallcasename)) and str(token8address) != '0'):
                                                    token = token8smallcasename.upper
                                                    selldecimals = int(api(token8address))
                                                    details = {'symbol': token, 'address': token8address,
                                                               'decimals': selldecimals,
                                                    ...
                                                    if balance_token8 < 3 and str(token9address) != '0' or (balance_token8 > 3 and gelukt == ("buy " + str(token8smallcasename)) and str(token9address) != '0'):
                                                        token = token9smallcasename.upper
                                                        selldecimals = int(api(token9address))
                                                        details = {'symbol': token, 'address': token9address,
                                                                   'decimals': selldecimals,
                                                        ...
                                                        if balance_token9 < 3 and str(token10address) != '0' and (
                                                                gelukt) != (
                                                                "buy " + str(token10smallcasename)) or (balance_token9 > 3 and gelukt == ("buy " + str(token9smallcasename)) and str(token10address) != '0'):
                                                            selldecimals = int(api(token10address))
                                                            token = token10smallcasename.upper
                                                            details = {'symbol': token, 'address': token10address,
                                                                       'decimals': selldecimals,
            ...
            def getprice(token1address, token1smallcasename, token2address, token2smallcasename, token3address,
                         ...
                         uniswap_wrapper, timesleep, gelukt):
                                            ...
                                            if str(token8address) !=  '0':
                                                ...
                                                if str(token9address) !=  '0':
                                                    if priceright == 'sell':
                                                        ...
                                                        pricetoken9usd = (priceeth['ethereum']['usd'] / (token9eth2))
                                                    else:
                                                    ...
                                                    if str(token10address) !=  '0':
                                                        if priceright == 'sell':
                                                            ...
                                                            pricetoken10usd = (priceeth['ethereum']['usd'] / (token10eth2))
                                                        else:
                ...
                try:
                    if str(token2address) != '0':
                        weergave1 = weergave1 + ('    [' + token2smallcasename + '  ' + str("{:.6f}".format(pricetoken2usd)) + ']')
                    if str(token3address) != '0':
                        weergave1 = weergave1 + ('    [' + token3smallcasename + '  ' + str("{:.6f}".format(pricetoken3usd)) + ']')
                    if str(token4address) != '0':
                        weergave1 = weergave1 + ('    [' + token4smallcasename + '  ' + str("{:.6f}".format(pricetoken4usd)) + ']')
                    if str(token5address) != '0':
                        weergave1 = weergave1 + ('    [' + token5smallcasename + '  ' + str("{:.6f}".format(pricetoken5usd)) + ']')
                    if str(token6address) != '0':
                        weergave1 = weergave1 + ('    [' + token6smallcasename + '  ' + str("{:.6f}".format(pricetoken6usd)) + ']')
                    if str(token7address) != '0':
                        weergave1 = weergave1 + ('    [' + token7smallcasename + '  ' + str("{:.6f}".format(pricetoken7usd)) + ']')
                    if str(token8address) != '0':
                        weergave1 = weergave1 + ('    [' + token8smallcasename + '  ' + str("{:.6f}".format(pricetoken8usd)) + ']')
                    if str(token9address) != '0':
                        weergave1 = weergave1 + ('    [' + token9smallcasename + '  ' + str("{:.6f}".format(pricetoken9usd)) + ']')
                    if str(token10address) != '0':
                        weergave1 = weergave1 + ('    [' + token10smallcasename + '  ' + str("{:.6f}".format(pricetoken10usd)) + ']')
                except Exception as e:
                    o=0
                try:
                    weergave=weergave1
            ...
            while True:
                if self.__abort == True and 'stop' not in locals():
                    # note that "step" value will not necessarily be same for every thread
                    #self.sig_done.emit(self.__id)
                    self.sig_msg.emit('Worker #{} aborting work at step {}'.format(self.__id))
                    stop=1
                    processEvents()
                    sys.exit()
                    break
                try:
                    ...
                    if 'gelukt' not in globals() or gelukt == "mislukt" or gelukt == "mislukt buy" or gelukt == "mislukt sell":
                        rara = checkbalance(infura_url, my_address, token1address, token2address, token3address, token4address,
                                     token5address,
                                     token6address, token7address,token8address,token9address,token10address,maincoinoption)
                        gelukt = rara['gelukt']
                    ...
                    while True:
                        ...
                        if self.__abort==True and 'stop' not in globals():
                            # note that "step" value will not necessarily be same for every thread
                            #self.sig_done.emit(self.__id)
                            self.sig_msg.emit('Worker #{} aborting work at step {}'.format(self.__id))
                            stop=1
                        ...
                        try:
                            ...
                            ku = getprice(token1address=token1address, token1smallcasename=token1smallcasename,
                                          ...
                                          uniswap_wrapper=Uniswap(address, private_key, web3=w3, version=2),
                                          timesleep=timesleep, gelukt=gelukt)
                        ...
                        if notyet == 3:
                            ...
                            oke= letstrade(keer,tradewithERCtoken1, tradewithERCtoken2, tradewithERCtoken3, tradewithERCtoken4,
                                tradewithERCtoken5, tradewithERCtoken6, tradewithERCtoken9, tradewithERCtoken7,
                              tradewithERCtoken8, tradewithERCtoken10, activatetoken1, activatetoken2, activatetoken3,
                              activatetoken4, activatetoken5, activatetoken6, activatetoken9, activatetoken7,
                              activatetoken8, activatetoken10, tradewithETHtoken1, tradewithETHtoken2, tradewithETHtoken3,
                    ...
                    if internetcheck is False:
                        try:
                            #p = subprocess.Popen(['powershell.exe', 'netsh wlan connect "Rijnstaat  78"'], stdout=sys.stdout)
                            time.sleep(5)
                        except:
                            time.sleep(5)
                            #p = subprocess.Popen(['powershell.exe', 'netsh wlan connect "Rijnstaat  78"'], stdout=sys.stdout)
...
class Ui_MainWindow(QGraphicsObject):
    ...
    def setupUi(self,MainWindow):
        ...
        self.startbutton.setGeometry(QtCore.QRect(920, 580, 121, 71))
        self.startbutton.setObjectName("startbutton")
        self.stopbutton = QtWidgets.QPushButton(self.centralwidget)
        self.stopbutton.setGeometry(QtCore.QRect(750, 580, 171, 71))
        ...
        self.gweioption.setGeometry(QtCore.QRect(760, 390, 81, 21))
        ...
        self.line_3.setGeometry(QtCore.QRect(-40, 430, 1081, 20))
        ...
        self.line.setGeometry(QtCore.QRect(720, 360, 20, 81))
    ...
    def updatenames(self):
        ...
        try:
            token5smallcasename = 0
            token5smallcasename = \
                cg.get_coin_info_from_contract_address_by_id(contract_address=self.token5ethaddress.text(),id='ethereum')['symbol']
    ...
    def start_threads(self):
            try:
                ...
                token3smallcasename = 0
                token3smallcasename = \
                    cg.get_coin_info_from_contract_address_by_id(contract_address=self.token3ethaddress.text(), id='ethereum')['symbol']
                self.token3name.setText(token3smallcasename)
                token4smallcasename = 0
                token4smallcasename = \
                    cg.get_coin_info_from_contract_address_by_id(contract_address=self.token4ethaddress.text(), id='ethereum')['symbol']
                self.token4name.setText(token4smallcasename)
                token5smallcasename = 0
                token5smallcasename = \
                    cg.get_coin_info_from_contract_address_by_id(contract_address=self.token5ethaddress.text(), id='ethereum')['symbol']
                ...
                token6smallcasename = 0
                token6smallcasename = \
                    cg.get_coin_info_from_contract_address_by_id(contract_address=self.token6ethaddress.text(), id='ethereum')['symbol']
                self.token6name.setText(token6smallcasename)
                token7smallcasename = 0
                token7smallcasename = \
                    cg.get_coin_info_from_contract_address_by_id(contract_address=self.token7ethaddress.text(), id='ethereum')['symbol']
                self.token7name.setText(token7smallcasename)
                token8smallcasename = 0
                token8smallcasename = \
                    cg.get_coin_info_from_contract_address_by_id(contract_address=self.token8ethaddress.text(), id='ethereum')[
                        'symbol']
                self.token8name.setText(token8smallcasename)
                token9smallcasename = 0
                token9smallcasename = \
                    cg.get_coin_info_from_contract_address_by_id(contract_address=self.token9ethaddress.text(), id='ethereum')[
                        'symbol']
                self.token9name.setText(token9smallcasename)
                token10smallcasename = 0
                token10smallcasename = \
                    cg.get_coin_info_from_contract_address_by_id(contract_address=self.token10ethaddress.text(), id='ethereum')[
                        'symbol']
                self.token10name.setText(token10smallcasename)
            except Exception as e:
                o = 0
    ...
    def on_worker_done(self, worker_id):
        ...
        if self.__workers_done == self.NUM_THREADS:
            ...
            for thread, worker in self.__threads:  # note nice unpacking by Python, avoids indexing
                worker.abort()  # <- so you need to wait for it to *actually* quit
